<x-guest-layout>
    ...
    <select id="gender" name="gender" class="block mt-1 w-full border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
    ...
    <!-- Country -->
        ...
        <div>
            ...
            <x-text-input id="zipcode" class="block mt-1 w-full" type="number" name="zipcode" :value="old('zipcode')" required autofocus autocomplete="zipcode" />
